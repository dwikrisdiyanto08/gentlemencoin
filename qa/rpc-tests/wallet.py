...
#   c) node1 mines 32 blocks, so now node 0 has 60001gent, node 1 has 4250gent, node2 has none.
#   d) node0 sends 601 gent to node2, in two transactions (301 gent, then 300 gent).
