...
In order to support loading of multiple wallets in gents-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gents.cpp.
...
Changes to gents.cpp
----------------------
gents.cpp is the entry point into gents-qt, and as such, will require some minor modifications to provide hooks for
