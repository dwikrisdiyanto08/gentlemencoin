...
//
// Bootup the Masternode, look for a 2000 GENT input and register on the network
//
...
//            if (service.GetPort() != 11221) {
//                notCapableReason = strprintf("Invalid port: %u - only 11221 is supported on mainnet.", service.GetPort());
//                LogPrintf("CActiveMasternode::ManageStatus() - not capable: %s\n", notCapableReason);
//                return;
//            }
//        } else if (service.GetPort() == 11221) {
//            notCapableReason = strprintf("Invalid port: %u - 11221 is only supported on mainnet.", service.GetPort());
//            LogPrintf("CActiveMasternode::ManageStatus() - not capable: %s\n", notCapableReason);
//            return;
//        }
...
//    if (Params().NetworkID() == CBaseChainParams::MAIN) {
//        if (service.GetPort() != 11221) {
//            errorMessage = strprintf("Invalid port %u for masternode %s - only 11221 is supported on mainnet.", service.GetPort(), strService);
//            LogPrintf("CActiveMasternode::Register() - %s\n", errorMessage);
//            return false;
//        }
//    } else if (service.GetPort() == 11221) {
//        errorMessage = strprintf("Invalid port %u for masternode %s - 11221 is only supported on mainnet.", service.GetPort(), strService);
//        LogPrintf("CActiveMasternode::Register() - %s\n", errorMessage);
//        return false;
//    }
