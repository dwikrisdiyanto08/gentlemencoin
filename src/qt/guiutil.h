...
/** Utility functions used by the Gents Qt UI.
 */
namespace GUIUtil
{
...
// Render Gents addresses in monospace font
...
// Parse "gents:" URI into recipient object, return true on successful parsing
