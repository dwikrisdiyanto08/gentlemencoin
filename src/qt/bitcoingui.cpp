                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gents Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send_dark"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a Gents address"));
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receive_dark"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gents: URIs)"));
    ...
    historyAction = new QAction(QIcon(":/icons/history_dark"), tr("&Transactions"), this);
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGENT"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternode_dark"), tr("&Masternodes"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gents Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gents Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gents"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gents addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gents addresses"));
    ...
    openAction->setStatusTip(tr("Open a Gents: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gents Core help message to get a list with possible Gents command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gents Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoOverviewPage()
{
    ...
    if (walletFrame)
    {
        ...
        receiveCoinsAction->setIcon(QIcon(":/icons/receive_dark"));
        masternodeAction->setIcon(QIcon(":/icons/masternode_dark"));
        sendCoinsAction->setIcon(QIcon(":/icons/send_dark"));
        historyAction->setIcon(QIcon(":/icons/history_dark"));
...
void BitcoinGUI::gotoHistoryPage()
{
    ...
    if (walletFrame)
    {
        overviewAction->setIcon(QIcon(":/icons/overview_dark"));
        receiveCoinsAction->setIcon(QIcon(":/icons/receive_dark"));
        masternodeAction->setIcon(QIcon(":/icons/masternode_dark"));
        sendCoinsAction->setIcon(QIcon(":/icons/send_dark"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gents network", "", count));
}
...
{
    QString strTitle = tr("Gents Core"); // default title
