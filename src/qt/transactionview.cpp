                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Gent from zGent"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGent"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGent));
