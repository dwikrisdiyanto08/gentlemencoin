...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gents features */
        {"gents", "masternode", &masternode, true, true, false},
        {"gents", "listmasternodes", &listmasternodes, true, true, false},
        {"gents", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gents", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gents", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gents", "masternodedebug", &masternodedebug, true, true, false},
        {"gents", "startmasternode", &startmasternode, true, true, false},
        {"gents", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gents", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gents", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gents", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gents", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gents", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gents", "mnbudget", &mnbudget, true, true, false},
        {"gents", "preparebudget", &preparebudget, true, true, false},
        {"gents", "submitbudget", &submitbudget, true, true, false},
        {"gents", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gents", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gents", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gents", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gents", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gents", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gents", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gents", "checkbudgets", &checkbudgets, true, true, false},
        {"gents", "mnsync", &mnsync, true, true, false},
        {"gents", "spork", &spork, true, true, false},
        {"gents", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gents", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gentsd, or the -server option to gents-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gents-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11222/\n";
}
