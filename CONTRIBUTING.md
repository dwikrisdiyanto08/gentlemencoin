Contributing to Gents Core
============================

The Gents Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gents Core project, and is not to be
confused with overall Gents Network Protocol consensus changes.

Whether a pull request is merged into Gents Core rests with the project merge
...
Patches that change Gents consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gents consensus, it must have been
...
The project leader is the release manager for each Gents Core release.
